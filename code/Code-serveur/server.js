...
serveur.get('/profilpublic/:username',async function(req,res){
    ...
    const [rows, fields] = await con.execute('SELECT * FROM user WHERE nom=?', [username]);

    var test = JSON.stringify(rows);
    var json = JSON.parse(test);

    
    res.sendFile(path.resolve(__dirname+'/../Code-FrontEnd/Html/profilpublic.html'))
});

serveur.get('/profilpublicdata', function(req,res){
